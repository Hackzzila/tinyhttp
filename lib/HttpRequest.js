...
var HttpRequest = function (_stream$Readable) {
  ...
  function HttpRequest(method, u) {
     ...
     * @type {Object}
     */
    _this.headers = { 'User-Agent': 'node-tinyhttp', 'Accept-Encoding': zlib ? 'gzip, deflate' : '' };
  ...
  _createClass(HttpRequest, [{
    ...
    key: 'attach',
    value: function attach(name, content, filename) {
      if (!this._multipart) {
        this._multipart = true;
        this._boundary = '----------------------' + crypto.randomBytes(32).toString('hex');
        this.set('Content-Type', 'multipart/form-data; boundary=' + this._boundary);
    ...
    value: function request(u, redirects, isStream) {
      ...
      return new Promise(function (resolve) {
        if (_this3._multipart) _this3.body = _this3.body.concat('\n--' + _this3._boundary + '--').trim();
        ...
        var req = module.request(Object.assign({}, u, {
          ...
          headers: Object.assign(_this3.headers, _this3._form ? _this3._form.getHeaders() : {})
        }), function (res) {
